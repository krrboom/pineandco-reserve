...
const TR = {
  ...
  ko: {
    ...
    rPolicy: `<p style="margin:0 0 8px;">정시 도착 부탁드립니다. 다른 손님을 위해 예약 시간보다 <strong style="color:#c9a96e;">5분 이상</strong> 늦으시면 노쇼로 처리됩니다.</p><p style="margin:0 0 8px;">조금 늦으시거나 입구를 못 찾으시면 전화 주세요 — 기꺼이 안내해 드릴게요.</p><p style="margin:0;">변경·취소는 <strong style="color:#b8935a;">${CONFIG.BUSINESS_PHONE}</strong> 로 전화 부탁드립니다.</p>`,
  ...
  zh: {
    ...
    rPolicy: `<p style="margin:0 0 8px;">请准时到达。为照顾所有客人，迟到超过 <strong style="color:#c9a96e;">5 分钟</strong> 的座位将被视为爽约并释放。</p><p style="margin:0 0 8px;">稍有迟到，或找不到入口？请致电，我们乐意为您引导入内。</p><p style="margin:0;">如需更改或取消，请致电 <strong style="color:#b8935a;">${CONFIG.BUSINESS_PHONE}</strong>。</p>`,
  ...
  ja: {
    ...
    rPolicy: `<p style="margin:0 0 8px;">時間どおりのご来店をお願いします。他のお客様への配慮のため、ご予約時間より <strong style="color:#c9a96e;">5分以上</strong> 遅れるとキャンセル扱いとなります。</p><p style="margin:0 0 8px;">少し遅れる、または入口が分からない場合はお電話ください。喜んでご案内します。</p><p style="margin:0;">変更・キャンセルは <strong style="color:#b8935a;">${CONFIG.BUSINESS_PHONE}</strong> までお電話ください。</p>`,
